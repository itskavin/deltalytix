...
```html
<iframe 
  src="https://trades.thekavin.com/embed?lang=fr&charts=trade-distribution"
  width="100%" 
  height="400">
</iframe>
```
...
**Single Chart:**
```html
<iframe src="https://trades.thekavin.com/embed?chart=pnl-per-contract-daily"></iframe>
```

**Multiple Charts:**
```html
<iframe src="https://trades.thekavin.com/embed?charts=trade-distribution,weekday-pnl,time-of-day"></iframe>
```

**All Charts:**
```html
<iframe src="https://trades.thekavin.com/embed"></iframe>
```
