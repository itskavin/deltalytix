...
export default {
  ...
  "authentication.testimonialAuthor": "Kavin",
  ...
  "dashboard.aiSettings": "Paramètres IA",
  ...
  "aiSettings.description": "Choisissez quel fournisseur IA utiliser pour l'assistant et l'analyse de trading.",
  "aiSettings.providerTitle": "Fournisseur par défaut",
  "aiSettings.providerDescription": "OpenAI reste disponible ; vous pouvez passer à Gemini ou Ollama à tout moment.",
  "aiSettings.provider": "Fournisseur",
  "aiSettings.provider.openai": "OpenAI",
  "aiSettings.provider.gemini": "Gemini",
  "aiSettings.provider.ollama": "Ollama",

  "aiSettings.geminiTitle": "Gemini",
  "aiSettings.geminiDescription": "Utilisez votre propre clé API Gemini.",
  "aiSettings.geminiApiKey": "Clé API Gemini",
  "aiSettings.geminiApiKeyPlaceholder": "Collez votre clé API Gemini",
  "aiSettings.geminiApiKeySaved": "Enregistrée",
  "aiSettings.geminiModel": "Modèle Gemini",

  "aiSettings.ollamaTitle": "Ollama",
  "aiSettings.ollamaDescription": "Connectez-vous à un serveur Ollama local ou distant.",
  "aiSettings.ollamaHostUrl": "URL de l'hôte Ollama",
  "aiSettings.ollamaHostUrlPlaceholder": "ex. http://localhost:11434",
  "aiSettings.loadOllamaModels": "Charger les modèles",
  "aiSettings.ollamaModel": "Modèle Ollama",
  "aiSettings.ollamaModelPlaceholder": "Sélectionnez un modèle",
  "aiSettings.ollamaModelNoModels": "Aucun modèle chargé",
