...
export default {
  ...
  "dashboard.aiSettings": "AI Settings",
  ...
  "aiSettings.description": "Configure which AI provider to use for the assistant and trading analysis.",
  "aiSettings.providerTitle": "Default Provider",
  "aiSettings.providerDescription": "OpenAI stays available; you can switch to Gemini or Ollama anytime.",
  ...
  "aiSettings.geminiDescription": "Use your own Gemini API key.",
  "aiSettings.geminiApiKey": "Gemini API Key",
  "aiSettings.geminiApiKeyPlaceholder": "Paste your Gemini API key",
  "aiSettings.geminiApiKeySaved": "Saved",
  "aiSettings.geminiModel": "Gemini Model",

  "aiSettings.ollamaTitle": "Ollama",
  "aiSettings.ollamaDescription": "Connect to a local or remote Ollama server.",
  "aiSettings.ollamaHostUrl": "Ollama Host URL",
  "aiSettings.ollamaHostUrlPlaceholder": "e.g. http://localhost:11434",
  "aiSettings.loadOllamaModels": "Load models",
  "aiSettings.ollamaModel": "Ollama Model",
  "aiSettings.ollamaModelPlaceholder": "Select a model",
  "aiSettings.ollamaModelNoModels": "No models loaded",
